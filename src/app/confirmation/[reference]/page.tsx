  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 16px' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        <Link href={homeUrl(locale)} style={{ display: 'inline-block', padding: '12px 32px', background: '#3f6e51', color: '#fff', textDecoration: 'none', borderRadius: 4, fontSize: 13, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
